...
public class CodeGenForNode {
	...
	@Autowired
	AllFunctionsDAO allFunctionsDAO;
	...
	public CodeGenForNode(SensorNode sensorNode, MicrocontrollerDAO microcontrollerDAO, SensorNodeDAO sensorNodeDAO,
			SensorDAO sensorDAO, AllFunctionsDAO allFunctionsDAO, CommunicationDAO communicationDAO) {
	...
	public ArrayList<String> getIncludeLibraryListCpp(List<String> Sensor_list) {
		...
		for (String temp_sensor_id : Sensor_list) {
			// get the each comma seperated library names and put it the
			// arraylist fom the DB
	...
	public void getSensorFunctionCpp(HandleSensorFunctions handleSensorFunctions, List<String> Sensor_list,
			ModifyXMLFile xml) {

		ArrayList<String> result = new ArrayList<>();
		ArrayList<String> function_already_taken = new ArrayList<>();

		for (Map.Entry<String, HashMap<Integer, String>> entry : handleSensorFunctions.getNew_edited_functions()
				.entrySet()) {
	...
	public void CodeforNode() {
		...
		for (Map.Entry<String, ArrayList<String>> entry : adjacency_node.entrySet()) {
			...
			// Microcontroller
			// base_station=microcontrollerDAO.getMicrocontrollerById(key);
